...
export ZSH="/Users/mooland/.oh-my-zsh"
export EDITOR='nvim'
...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting zsh-vim-mode zsh-system-clipboard tmux tmuxinator)
...
export FZF_COMPLETION_TRIGGER='**' # change ** to whatever you likeF
