...
c.appearance.dimmer                   = 6.5                 -- Higher numbers increase contrast b/n focused & unfocused state  2.5
...
c.appearance.size                     = 18                  -- Size of window indicators (height when icons off) 32
c.appearance.radius                   = 2                   -- Indicator roundness. Higher numbers → *less* roundness… I'm sorry 3
c.appearance.iconPadding              = 1                   -- Space between icon & indicator edge. Higher numbers → smaller, more inset icons 4
c.appearance.pillThinness             = 6                   -- Aspect ratio of pill-style icons (width = size / pillThinness) 6
